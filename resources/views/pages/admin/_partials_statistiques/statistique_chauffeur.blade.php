    ...
    <div class="row">
        ...
        <div class="col-xl-6 col-md-6 mb-xl-0 mb-4">
            ...
            <div class="card card-cascade cascading-admin-card">
                <a href="{{ url('vente/vente-jour') }}">
                    <!-- Card Data -->
                    <div class="admin-up">
                        <i class="far fa-money-bill-alt primary-color mr-3 z-depth-2"></i>
                        <div class="data">
                            <p class="text-uppercase">Ventes</p>
                            <h4 class="font-weight-bold dark-grey-text"> {{-- {{ number_format($vente_jour, 3) }} F--}}akiola</h4>
                        </div>
                    </div>
        ...
        <div class="col-xl-6 col-md-6 mb-xl-0 mb-4">
            ...
            <div class="card card-cascade cascading-admin-card">
                <a href="{{ url('ma-boutique') }}">
                    ...
                    <div class="card-body card-body-cascade">
                        <div class="progress mb-3">
                           {{--}} @if ($nombre_article >= 1 && $nombre_article <= 10)
                                <div class="progress-bar red accent-2" role="progressbar" style="width: 10%"
                                    aria-valuenow="10" aria-valuemin="0" aria-valuemax="100"></div>
                            @elseif ($nombre_article >= 11 && $nombre_article <= 100) <div
                        ...
                        <p class="card-text">Nombre d'articles disponible dans la boutique</p>
                    </div>
                </a>
            </div>
            <!-- Card -->
